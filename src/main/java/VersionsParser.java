...
public class VersionsParser {
    ...
    private static final HashSet<String> desOptions = new HashSet<>(Arrays.asList("3DES", "Triple-DES", "Triple Des", "triple-DES", "DES3", "single-des", "TripleDES", "TDES"));
    ...
    public HashSet<String> getEalOptions() {
        return this.ealOptions;
    }

    public HashSet<String> getShaOptions() {
        return this.shaOptions;
    }

    public HashSet<String> getJavaOptions() {
        return this.javaOptions;
    }

    public HashSet<String> getGpOptions() {
        return this.gpOptions;
    }

    public HashSet<String> getDesOptions() {
        return this.desOptions;
    }

    public HashSet<String> getEccOptions() {
        return this.eccOptions;
    }

    public HashSet<String> getRsaOptions() {
        return this.rsaOptions;
    }

    public HashSet<String> getEalVersions() {
        return this.ealVersions;
    }

    public HashSet<String> getShaVersions() {
        return this.shaVersions;
    }

    public HashSet<String> getJavaVersions() {
        return this.javaVersions;
    }

    public HashSet<String> getGpVersions() {
        return this.gpVersions;
    }

    public HashSet<String> getDesVersions() {
        return this.desVersions;
    }

    public HashSet<String> getEccVersions() {
        return this.eccVersions;
    }

    public HashSet<String> getRsaVersions() {
        return this.rsaVersions;
    }
